<p align="center">
  <img src="pic1.png" alt="Maruf Hasan Anik" width="120" style="border-radius: 50%;" />
</p>

<h1 align="center">Maruf Hasan Anik</h1>

<p align="center">
  Full Stack Developer &nbsp;·&nbsp; AI Researcher &nbsp;·&nbsp; IT Executive @ DSE
</p>

<p align="center">
  <a href="https://www.linkedin.com/in/skipperanik/">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white" />
  </a>
  &nbsp;
  <a href="mailto:hasanmaruf0055@gmail.com">
...
BSc in Computer Science at AIUB (CGPA 3.74 / 4.00), currently working as an **IT Executive at Dhaka Stock Exchange**. I build full-stack systems across web, mobile, and AI — from real-time platforms to deep learning pipelines.

My thesis project, **CCTV-AI Guardian**, won the 🏆 **Best Poster Award** at AIUB's Science & Technology Showcase 2025, achieving 99% accuracy on the UCF Crime dataset using a YOLOv8 + CNN-LSTM fusion model.

Before engineering, I spent 6 years in **BNCC (Bangladesh National Cadet Corps)** — rising to Cadet Under Officer. It shaped how I operate: with discipline, precision, and accountability.
...
```
Role     →  IT Executive, MIS & Development — Dhaka Stock Exchange PLC
Stack    →  Java · JSF/PrimeFaces · Maven · Oracle · Agile
Focus    →  Internal financial systems · test engineering · process analysis
```
...
### ARK PlayZone — Indoor Playground Management System
> Next.js · NestJS · PostgreSQL · Kotlin · JWT · Pusher · RBAC · MVVM

Three-platform system (web admin, customer portal, Android app) with real-time updates, role-based access control, offline mobile storage, and file uploads. Built for a real business during my final semester.

[Frontend](https://github.com/Skippersquareroot100/ArkPlayZone/tree/main/next-frontend) · [Backend](https://github.com/Skippersquareroot100/ArkPlayZone/tree/main/nest-backend) · [Android](https://github.com/Skippersquareroot100/ArkPlayZone-android-app-)

---

### CCTV-AI Guardian — Real-Time Violence Detection · 🏆 Best Poster Award
> YOLOv8 · CNN-LSTM · MobileNetV2 · SaliNet · Python

Multi-model AI fusion pipeline for automated violence detection via CCTV. Achieved **99% accuracy** on UCF Crime & SCVD datasets, **97.5%** on Hockey Fight. Motion-triggered alerting with no manual review required.

---

### DashGallery
> Vue.js · Pinia · Tailwind CSS · Laravel 11

[GitHub](https://github.com/Skippersquareroot100/DashGallery)

---

### Enterprise Backend API
> .NET 8 · Entity Framework · SOLID · 3-Tier Architecture

[GitHub](https://github.com/Skippersquareroot100/net-Final-term-poject)
...
[GitHub](https://github.com/Skippersquareroot100/Webtech_Project)
...
![ASP.NET Core](https://skillicons.dev/icons?i=dotnet)
...
<img height="160" src="https://streak-stats.demolab.com?user=skippersquareroot100&theme=tokyonight&hide_border=true" />
&nbsp;
<img height="160" src="https://github-readme-stats.vercel.app/api?username=skippersquareroot100&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true&hide_border=true" />

<br/>

<img height="160" src="https://github-readme-stats.vercel.app/api/top-langs/?username=skippersquareroot100&layout=pie&theme=tokyonight&hide_border=true&langs_count=10" />
&nbsp;
<img height="160" src="http://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=skippersquareroot100&theme=tokyonight&utcOffset=6" />

<br/>

<img width="100%" src="http://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=skippersquareroot100&theme=tokyonight" />
...
| | |
|---|---|
| **3.74** | CGPA at AIUB (out of 4.00) |
| **5.00 / 5.00** | HSC · SSC · JSC · PSC — all four public exams |
| **99%** | AI model accuracy — UCF Crime & SCVD datasets |
| **350+** | Test cases authored at Dhaka Stock Exchange |
| **200+** | Competitive programming problems solved (Codeforces) |
| **15+** | Projects shipped across web, mobile, AI, and embedded |
| **6 years** | Bangladesh National Cadet Corps — Cadet Under Officer |

---

## Certifications

- **Full-Stack Web Development** — Ostad, July 2025
- **Introduction to Data Analytics on Google Cloud** — NetCom Learning / Google Cloud, August 2025
- **IT Essentials: PC Hardware and Software** — Cisco Networking Academy, May 2022
- **Wing Camp 2019** — Bangladesh National Cadet Corps (BNCC)
- **Squadron Training Exercise (STE)** — BNCC, March 2016
...
BSc in Computer Science and Engineering · Feb 2022 – Sep 2025 (Expected)
CGPA: 3.74 / 4.00 · 148 credits · 56 courses

**Birshreshtha Munshi Abdur Rouf Public College**
HSC (Science) 2020 — GPA 5.00 · SSC (Science) 2018 — GPA 5.00

---

<p align="center">
  <sub>Bangladesh Standard Time (UTC+6) · Open to freelance, remote, and full-time roles</sub>
</p>
...
<p align="left">
  <a href="https://www.linkedin.com/in/skipperanik/" target="_blank">
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Skippersquareroot100/Skippersquareroot100/gh-pages/snake-dark.svg" />
    <img src="https://raw.githubusercontent.com/Skippersquareroot100/Skippersquareroot100/gh-pages/snake-ocean.svg" />
  </picture>
</p>
